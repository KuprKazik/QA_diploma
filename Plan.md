...
Среднее время на разработку и выполнение одного теста = 20 минут (*52 теста)

Заведение баг-репорта на каждый дефект = 25 минут (* 10 багов)
